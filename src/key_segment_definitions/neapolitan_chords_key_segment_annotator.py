""" Implementation of Clear Key Segment Definition 6 from thesis.
"""
...
class NeapolitanChordsKeySegmentAnnotator(RelaxedKeySegmentAnnotator):
    """ Implementation of Clear Key Segment Definition 6 from thesis.
    ...
    4. Any non-scale note is a figuration or part of a Neapolitan chord.
    """
    ...
    def __init__(self, parsed_mxl, rntxt_analysis, measure_onset_finder,
        ...
        self.foreign_note_detector = ForeignNoteDetector(allow_neapolitan_chords=True)