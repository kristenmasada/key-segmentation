""" Implementation of Clear Key Segment Definition 7 from thesis.
"""
...
class Augmented6thKeySegmentAnnotator(RelaxedKeySegmentAnnotator):
    """ Implementation of Clear Key Segment Definition 7 from thesis.
    ...
    4. Any non-scale note is a figuration or part of an augmented 6th chord.
    """
    ...
    def __init__(self, parsed_mxl, rntxt_analysis, measure_onset_finder,
        ...
        self.foreign_note_detector = ForeignNoteDetector(allow_aug6_chords=True)