...
def plot_c_ks_t_ks_and_ct_ks_whole_segment_key_stats(song_event_key_probs_dict, ground_truth_key_labels_dict,
    ...
    if plot_correct_num_segments:
        plot_the_correct_num_segments(c_ks_whole_key_segment_stats_computer, t_ks_whole_key_segment_stats_computer,
                                      ct_ks_whole_key_segment_stats_computer)

    if plot_correct_num_segments_in_log_space:
        plot_the_correct_num_segments_in_log_space(c_ks_whole_key_segment_stats_computer, t_ks_whole_key_segment_stats_computer,
                                                   ct_ks_whole_key_segment_stats_computer)

    if plot_precision:
        plot_the_precision(c_ks_whole_key_segment_stats_computer, t_ks_whole_key_segment_stats_computer,
                           ct_ks_whole_key_segment_stats_computer)

    if plot_event_level_recall:
        plot_the_event_level_recall(c_ks_whole_key_segment_stats_computer, t_ks_whole_key_segment_stats_computer,
                                    ct_ks_whole_key_segment_stats_computer)

    if plot_recall:
        plot_the_recall(c_ks_whole_key_segment_stats_computer, t_ks_whole_key_segment_stats_computer,
                        ct_ks_whole_key_segment_stats_computer)
...
def plot_the_correct_num_segments(c_ks_whole_key_segment_stats_computer, t_ks_whole_key_segment_stats_computer,
                                  ct_ks_whole_key_segment_stats_computer):
    ...
    """
    whole_key_segment_stats_plotter = WholeKeySegmentLenCountPlotter(c_ks_whole_key_segment_stats_computer,
...
def plot_the_correct_num_segments_in_log_space(c_ks_whole_key_segment_stats_computer, t_ks_whole_key_segment_stats_computer,
                                               ct_ks_whole_key_segment_stats_computer):
...
def plot_the_precision(c_ks_whole_key_segment_stats_computer, t_ks_whole_key_segment_stats_computer,
                       ct_ks_whole_key_segment_stats_computer):
    ...
    ct_ks_whole_key_segment_stats_computer : WholeKeySegmentStatsComputer
    """
    whole_key_segment_precision_plotter = WholeKeySegmentPrecisionPlotter(c_ks_whole_key_segment_stats_computer,
                                                                          t_ks_whole_key_segment_stats_computer,
                                                                          ct_ks_whole_key_segment_stats_computer)
    whole_key_segment_precision_plotter.plot_seg_len_vs_precision()

def plot_the_event_level_recall(c_ks_whole_key_segment_stats_computer, t_ks_whole_key_segment_stats_computer,
                                ct_ks_whole_key_segment_stats_computer):
    ...
    ct_ks_whole_key_segment_stats_computer : WholeKeySegmentStatsComputer
    """
    whole_key_segment_event_level_recall_plotter = WholeKeySegmentEventLevelRecallPlotter(c_ks_whole_key_segment_stats_computer,
                                                                                          t_ks_whole_key_segment_stats_computer,
                                                                                          ct_ks_whole_key_segment_stats_computer)
    whole_key_segment_event_level_recall_plotter.plot_seg_len_vs_event_level_recall()

def plot_the_recall(c_ks_whole_key_segment_stats_computer, t_ks_whole_key_segment_stats_computer,
                    ct_ks_whole_key_segment_stats_computer):
    ...
    ct_ks_whole_key_segment_stats_computer : WholeKeySegmentStatsComputer
    """
    whole_key_segment_recall_plotter = WholeKeySegmentRecallPlotter(c_ks_whole_key_segment_stats_computer,
                                                                    t_ks_whole_key_segment_stats_computer,
                                                                    ct_ks_whole_key_segment_stats_computer)
...
def get_commandline_args():
    ...
    parser.add_argument('--predicted_c_ks_key_segment_indices_npz_path', type=str,
                        help='Path to .npz file containing the indices of '
                              'the events that should be included in each '
                              'predicted clear key segment.')
    parser.add_argument('--predicted_ct_ks_key_segment_indices_npz_path', type=str,
                        help='')
...
if __name__ == '__main__':
    ...
    if args.predicted_c_ks_key_segment_indices_npz_path:
        predicted_c_ks_key_segment_indices_dict = npz_file_handler.read_npz_file(args.predicted_c_ks_key_segment_indices_npz_path)
        ...
        predicted_c_ks_key_segment_indices_dict = None

    if args.predicted_ct_ks_key_segment_indices_npz_path:
        predicted_ct_ks_key_segment_indices_dict = npz_file_handler.read_npz_file(args.predicted_ct_ks_key_segment_indices_npz_path)
        ...
        predicted_ct_ks_key_segment_indices_dict = None
    ...
    plot_c_ks_t_ks_and_ct_ks_whole_segment_key_stats(song_event_key_probs_dict,
                                                     ground_truth_key_labels_dict,
                                                     predicted_c_ks_key_segment_indices_dict,
                                                     predicted_ct_ks_key_segment_indices_dict,
                                                     threshold,
